...
namespace Mxp.Win
{
    public sealed partial class HCUViewController : Page
    {
        public HCUViewController()
        {
            this.InitializeComponent();
            this.Title.Text = LoggedUser.Instance.Labels.GetLabel(Labels.LabelEnum.Hcu);
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Attendee = new Attendee(AttendeeTypeEnum.UCP);
